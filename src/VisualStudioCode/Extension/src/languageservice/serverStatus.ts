...
export class ServerStatusView implements IStatusView, vscode.Disposable  {
    ...
    public installingService(): void {
        ...
        this.showProgress('$(desktop-download) Installing');
    }

    public updateServiceDownloadingProgress(downloadPercentage: number): void {
        this._statusBarItem.text = `$(cloud-download) Downloading ... ${downloadPercentage}%`;
        this._statusBarItem.show();
    }
    ...
    public serviceInstalled(): void {
        ...
        this._statusBarItem.command = undefined;
        this._statusBarItem.text = 'Sql Tools Service installed';
        this._statusBarItem.show();
    ...
    public serviceInstallationFailed(): void {
        this._statusBarItem.command = undefined;
        this._statusBarItem.text = 'Failed to install Sql Tools Service';
        this._statusBarItem.show();
    }
    ...
    private showProgress(statusText: string): void {
        ...
        setInterval(() => {
            ...
            if (this._statusBarItem.text !== 'Sql Tools Service installed') {
